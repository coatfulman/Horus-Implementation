...
#                 posY = check(lowY=200,highY=221,posY=posY)
                posY = check(lowY=0.762,highY=2.032,posY=posY)
                posY = check(lowY=3.7846,highY=5.0546,posY=posY)
                posY = check(lowY=6.604,highY=7.874,posY=posY)
                posY = check(lowY=9.5504,highY=10.8204,posY=posY)
